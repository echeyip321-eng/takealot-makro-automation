...
class MakroApi:
    ...
    def __init__(self, api_key, api_secret):
        ...
        self.oauth_url = 'https://seller.makro.co.za/api/oauth-service/oauth/token?grant_type=client_credentials'
...
def fetch_takealot_search(query='Air Fryer', limit=10):
    ...
    try:
        ...
        resp.raise_for_status()
        time.sleep(2)  # Wait like real user
    except Exception as e:
